<template>
    <div>
        ...
        <div class="text-right">
            <button class="btn btn-dark  mt-4" @click="openModal(true)" data-target="#productModal">建立新產品</button>
            <table class="table mt-4 text-left table-striped table-hover table-warning" >
                <thead class="bg-gold" >
                    <th width="120">分類</th>
                    <th>產品名稱</th>
                    <th width="120">原價</th>
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-header bg-dark text-white">
                    ...
                    <span class="text-gold">新增產品</span>
                    </h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info text-gold" @click="updateProduct">確認</button>
                </div>
                </div>
            </div>
            </div>
